...
"                    Sam Bateman <sam.bateman@nrlssc.navy.mil>,
...
syn keyword   lammpsThermo    step elapsed elaplong dt time cpu tpcpu spcpu cpuremain part timeremain atoms temp press pe ke etotal
syn keyword   lammpsThermo    evdwl ecoul epair ebond eangle edihed eimp emol elong etail enthalpy ecouple econserve vol density
syn keyword   lammpsThermo    lx ly lz xlo xhi ylo yhi zlo zhi xy xz yz xlat ylat zlat bonds angles dihedrals impropers pxx pyy pzz
syn keyword   lammpsThermo    pxy pxz pyz fmax fnorm nbuild ndanger cella cellb cellc cellalpha cellbeta cellgamma
...
syn match lammpsFixName      "f_\w\+"
syn match lammpsComputeName  "c_\w\+"
...
if !exists("did_lammps_syntax_inits")
    ...
    hi link lammpsFixName     Identifier
    hi link lammpsComputeName Identifier
    hi link lammpsThermo      Keyword
