...
" called peachpuff?).
"
" Note: Only GUI colors differ from default, on terminal it's just `light'. This is a personnal fork from the original peachpuff scheme. Biggest (if not only) difference is a dark bg.
